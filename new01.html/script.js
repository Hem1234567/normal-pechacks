        ...
        function handleResize() {
            ...
            if (windowSize.width < 640) {
                ...
                hudTitle.textContent = 'PEC HACKS';
            ...
            // Adjust button container position for mobile
            const buttonContainer = document.querySelector('.button-container');
            if (windowSize.width < 640) {
                buttonContainer.style.marginTop = '280px';
            } else {
                buttonContainer.style.marginTop = '380px';
            }
        }
...
/*PATRONS SECTION  CODE STARTS STAR HERE */
        ...
        function downloadSponsorshipDeck() {
            ...
            link.href = 'https://example.com/path/to/sponsorship-deck.pdf'; // Replace with actual URL
